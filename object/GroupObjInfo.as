package Evocati.object
{
	...
	public class GroupObjInfo implements IObj3D
	{
		...
		public function GroupObjInfo(pId:String,pX:Number,pY:Number,pZ:Number)
		{
			id = pId;
			x = pX;
			y = pY;
		...
		public function addChildObj(info:BaseObjInfo):void
		{
		...
		public function addChildObjAt(info:BaseObjInfo,i:int):void
		{
			var ox:Number = info.originX;
			var oy:Number = info.originY;
		...
		public function getChild(index:int):BaseObjInfo
		{
